...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // Legacy API credential methods (deprecated)
  setTwitchCredentials: (clientId: string, accessToken: string) => ipcRenderer.invoke('config:setTwitchCredentials', clientId, accessToken),
  setYouTubeCredentials: (apiKey: string) => ipcRenderer.invoke('config:setYouTubeCredentials', apiKey), 
  setKickCredentials: (clientId?: string, accessToken?: string) => ipcRenderer.invoke('config:setKickCredentials', clientId, accessToken),
